...
implemented in rust as a cli program. Implemented in a few hours as a fun little project while I was on vacation.
...
Like any other rust program, start it by simply running `cargo run`, or you can use `make`
